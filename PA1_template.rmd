...
```{r getDataSets, include=TRUE, echo=TRUE}
#Load Training Data
...
```{r computeMean, include=TRUE, echo=TRUE}
mean(stepsPerDay, na.rm=TRUE)
```

```{r computeMedian, include=TRUE, echo=TRUE}
median(stepsPerDay, na.rm=TRUE)
```

####**3. Time series plot of the average number of steps taken**
```{r timeSeriesStepsTaken, include=TRUE, echo=TRUE}
...
```{r maximumValue, include=TRUE, echo=TRUE}
...
```{r imputeMissingValues, include=TRUE, echo=TRUE}
...
```{r histogramMissingValues, include=TRUE, echo=TRUE}
...
```{r compareWeekdaysWeekends, include=TRUE, echo=TRUE}
...
#### All of the above code along with the dataset should fulfill this requirement.
